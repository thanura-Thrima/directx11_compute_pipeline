...
VertexShaderNew::VertexShaderNew(std::string name, std::string fileName, ID3D11Device* device, ID3D11DeviceContext* devicContext)
...
#endif
    // Prefer higher VS shader profile when possible as VS 5.0 provides better performance on 11-class hardware.
...
VertexShaderNew::~VertexShaderNew() {
}
